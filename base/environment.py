...
from base.shell import Device, Shell
...
class EnvironmentAndroid(Environment):
    ...
    def get_conf(self):
        ...
        with open(environment_info_path, "r", encoding="utf-8") as f:
    ...
    def check_environment(self):
        ...
        for device in self.devices.values():
            ...
            if device_name in current_devices:
                log.info('已正常连接设备{}'.format(device_name))
            else:
                log.error('设备{}未正常连接'.format(device_name))
