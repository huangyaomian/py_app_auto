...
class HomePage(BasePage):
    ...
    def load_android(self):
        self.activity = "com.qooapp.qoohelper.arch.welcome.WelcomeActivity"
        # self.activity = "com.jm.android.jumei.home.activity.NewHomeActivity"

        self.关闭初始化浮窗 = self.get_locator('关闭初始化浮窗', 'tap', '891,132')
        self.关闭初始化弹出窗 = self.get_locator("关闭初始化弹出窗", 'id', 'com.qooapp.qoohelper.testfairy:id/tv_home_search')

        self.進入搜索頁按鈕 = self.get_locator("進入搜索頁按鈕", 'id', 'com.qooapp.qoohelper.testfairy:id/tv_home_search')
        self.搜索输入框 = self.get_locator("搜索输入框", 'id', 'com.qooapp.qoohelper.testfairy:id/edtInput')
...
class CategoryListPage(BasePage):
    ...
    def load_android(self):
        ...
        self.搜索输入框 = self.get_locator("搜索输入框", 'id', 'com.qooapp.qoohelper.testfairy:id/edtInput')
        self.搜索按钮 = self.get_locator("搜索按钮", 'id', 'com.qooapp.qoohelper.testfairy:id/itv_search_icon')
...
class SearchListPage(BasePage):
    ...
    def load_android(self):
        ...
        self.遊戲譯名 = self.get_locator("商品项标题", 'id', 'com.qooapp.qoohelper.testfairy:id/tv_gameName')
...
class ProductDetailsPage(BasePage):
    ...
    def load_android(self):
        ...
        self.促销弹窗标题 = self.get_locator("促销弹窗标题", 'id', 'com.jm.android.jumei:id/tv_detail_title',
                                       dynamic=True)  # text 属性为促销
